	...
	data: new SlashCommandBuilder()
		...
		.addSubcommand(subcommand => subcommand
			...
			.addIntegerOption(option => option
				.setName("number")
				.setDescription("The number to get a fact about. Leave empty for a random number"))
		)
		...
		.addSubcommand(subcommand => subcommand
			...
			.addIntegerOption(option => option
				.setName("year")
				.setDescription("The year to get a fact about. Leave empty for a random year"))
		)
